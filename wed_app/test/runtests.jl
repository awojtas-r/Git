...
# !!! Main.UserApp is configured as an alias for Main.WedApp and you might encounter it in some tests
using Main.WedApp, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "WedApp tests" begin
  @includetests ARGS
end
